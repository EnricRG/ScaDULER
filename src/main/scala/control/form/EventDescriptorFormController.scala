...
class EventDescriptorFormController[S >: Null <: SubjectLike, C <: CourseLike, R >: Null <: ResourceLike, E <: EventLike](
  ...
  override protected def initializeContentLanguage(): Unit = {
    eventNameTag.setText(AppSettings.language.getItemOrElse(
      "eventForm_eventName",
      "Event name") + ":")

    eventNameField.setPromptText(AppSettings.language.getItemOrElse(
      "eventForm_eventNameHelp",
      "Full Event name"))

    eventShortNameTag.setText(AppSettings.language.getItemOrElse(
      "eventForm_eventShortName",
      "Event short name") + ":")

    eventShortNameField.setPromptText(AppSettings.language.getItemOrElse(
    ...
    eventDescriptionField.setPromptText(AppSettings.language.getItemOrElse(
    ...
    eventQuarterTag.setText(AppSettings.language.getItemOrElse("eventForm_eventQuarterTag", "Quarter") + ":")

    eventSubjectTag.setText(
      AppSettings.language.getItemOrElse("eventForm_eventSubjectTag", "Subject") + " " +
      AppSettings.language.getItemOrElse("optional_tag", "(Optional)") + ":")

    eventDurationTag.setText(AppSettings.language.getItemOrElse("eventForm_eventDurationTag", "Duration") + ":")

    eventTypeTag.setText(AppSettings.language.getItemOrElse("eventForm_eventTypeTag", "Event type"))

    eventPeriodicityTag.setText(AppSettings.language.getItemOrElse(
    ...
    createEventButton.setText(AppSettings.language.getItemOrElse(
