...
import java.util.{ArrayList, Collection, HashMap, HashSet, List}
...
import model.{Color, Course, CourseLike, Event, EventLike, EventType, EventTypes, Quarter, Quarters, Resource, ResourceLike, Subject, Weeks}
