...
object DefaultLanguage extends Language {
    override val items = Map(
        ...
        "noCourse" -> "No Course", //obsolete
        "noQuarter" -> "No Quarter", //obsolete
        ...
        "subjectForm_subjectDescriptionTag" -> "Subject Description",
        ...
        "eventForm_eventSubjectTag" -> "Subject",
        ...
        "manageIncompatibilities_assignIncompatibilities" -> "Assigned Incompatibilities",
        "manageIncompatibilities_incompatibilityTablePlaceholder" -> "No incompatibilities",
        "manageIncompatibilities_nameColumnHeader" -> "Name",
        "manageIncompatibilities_selectAllIncompatibilities" -> "Select All Incompatibilities",
        "manageIncompatibilities_allEventsHeader" -> "All Events",
        "manageIncompatibilities_searchEvent" -> "Enter event name",
        "manageIncompatibilities_selectAllEvents" -> "Select All Events",
