...
object MiniZincConstants {
    ...
    val PredefinedDZNFilePath: String = AppSettings.tempPath +  "data.dzn" //unused
    ...
    def predefinedDZNFilePath(append: String): String = AppSettings.tempPath + "data" + append + ".dzn"
}
